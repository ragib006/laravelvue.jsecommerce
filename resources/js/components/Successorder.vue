<template>
    <div>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body" >
                      ...
                      <table id="section" class="table table-bordered table-striped">
                        ...
                        <tr v-for="showorder in showallsuccessorder">
      ...
      <center>
        ...
        <a class="btn btn-danger btn-sm" style="margin-top:17px;" @click.prevent = "deletesuccessorder(showorder.id)"><i class="fa fa-trash" aria-hidden="true"></i></a>
      </center>
    ...
    methods:{
      ...
      //show all success category
              allsuccessorder(){
               ...
               axios.get('/show_all_success_order').then(({data}) => (this.showallsuccessorder = data));


             },


             deletesuccessorder(id){

               axios.get('/delete_success_order/'+id)
             ...
             //this.$router.push('/add_product')
               .then((response)=>{
                    ...
                    this.$router.push('/successorder')
                     this.allsuccessorder();
                     Toast.fire({
                     icon: 'success',
                     title: 'Success Order delate Successfully'
                      })
                   })
