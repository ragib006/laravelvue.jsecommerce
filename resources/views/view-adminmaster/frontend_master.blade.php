...
<head>
  ...
  <meta name="csrf-token" content="{{ csrf_token() }}">
    ...
    <!-- css -->
    <link href="{{asset('/frontend')}}/https://fonts.googleapis.com/css?family=Noto+Serif:400,400italic,700|Open+Sans:300,400,600,700" rel="stylesheet">
    ...
    <!-- Fav and touch icons -->
    <link rel="{{asset('/frontend')}}/apple-touch-icon-precomposed" sizes="144x144" href="ico/apple-touch-icon-144-precomposed.png" />
    <link rel="{{asset('/frontend')}}/apple-touch-icon-precomposed" sizes="114x114" href="ico/apple-touch-icon-114-precomposed.png" />
    <link rel="{{asset('/frontend')}}/apple-touch-icon-precomposed" href="ico/apple-touch-icon-57-precomposed.png" />
    <link rel="{{asset('/frontend')}}/shortcut icon" href="ico/favicon.png" />
    ...
    <!-- <header>
      <div class="container ">
        ...
        <div class="row">
          <div class="span4">
            <div class="logo">
              <a href="index.html"><img src="{{asset('/frontend')}}/img/logo.png" alt="" class="logo" /></a>
              ...
              <div class="navigation">
                <nav>
                  <ul class="nav topnav">
                    ...
                    <li class="dropdown">
                      <router-link to="/blog_page">Blog </router-link>
          ...
          <div class="span3">
            <div class="widget">
              ...
              <div class="flickr_badge">
                <script type="text/javascript" src="{{asset('/frontend')}}/http://www.flickr.com/badge_code_v2.gne?count=8&amp;display=random&amp;size=s&amp;layout=x&amp;source=user&amp;user=34178660@N03"></script>
              </div>
              <div class="clear">
              </div>
            </div>
