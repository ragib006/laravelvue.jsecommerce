                ...
                <table id="section" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td style="text-align:center;padding-top:30px;">
                      ...
                      @if($v_show->order_status=='pending')

                       <span style="display:block;text-align:center;width:80px;margin-left:30px;" class="btn btn-danger btn-sm">Pending</span>

                      @else

                       <span style="display:block; text-align:center;width:80px;margin-left:30px;"  class="btn btn-success btn-sm" >Approve</span>
...
<center>
  ...
  <a class="btn btn-warning btn-sm" style="margin-top:20px;"  href="{{URL::to('/view_order_details/'.$v_show->id)}}"><i class="fa fa-eye" aria-hidden="true"></i></a>
  <a class="btn btn-danger btn-sm" style="margin-top:20px;" id="delate" href="{{URL::to('/order_delate/'.$v_show->id)}}"><i class="fa fa-trash" aria-hidden="true"></i></a>
</center>
