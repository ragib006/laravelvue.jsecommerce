...
@section('change')
           ...
           <div class="card card-primary" style="width:650px;margin-left:300px;margin-bottom:260px;margin-top:50px;">
             <div class="card-header">
               <h3 class="card-title">Edit Today Expand Information</h3>
             </div>
             <!-- /.card-header -->
             <!-- form start -->
     ...
     <form enctype="multipart/form-data" role="form" method="post" action="{{url('/expand_todayedit_form_action_route/'.$placeholder_value_expand->id)}}">
         {{ csrf_field() }}
       <div class="card-body">
