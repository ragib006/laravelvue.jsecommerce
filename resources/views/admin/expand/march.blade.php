          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-header">
                <h3 class="card-title">March Expands Information</h3>
                 <center style="padding:0px;margin:0px;out-line:0px;">

                  <h4>March Expands : {{$year_total_amount}} TK</h4>
...
<center>
  ...
  <a class="btn btn-danger btn-sm" style="margin-top:30px;" id="delate" href="{{URL::to('/mar_expand_delate_route/'.$v_show->id)}}"><i class="fa fa-trash" aria-hidden="true"></i></a>
